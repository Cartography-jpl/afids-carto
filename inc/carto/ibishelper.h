...
// 10-09-2019 - Ray Bambery - added IBISHELPER_lowerString
#include <stdio.h>
...
/* data                                          */
/* data gets written out when                    */
/* IBISHELPER2_closeIBIS is called               */
/*                                               */
/* col and index start offset at 0 not 1         */
//void IBISHELPER2_setString(IBISStruct2 *ibis2, int row, int col, char *str);
...
/*                                               */
/* col and index start offset at 0 not 1         */
//void IBISHELPER2_setDouble(IBISStruct2 *ibis2, int row, int col, double data);

/* writes out data if mode is write or update,   */
/* closes the file and deletes the ibis struct   */
//void IBISHELPER2_closeIBIS(IBISStruct2 **ibis2);
